...
legitimate_df = pd.read_csv("websites_legitimate.csv")
phishing_df = pd.read_csv("websites_phishing.csv")
...
data = {'accuracy': [SVM_accuracy, DT_accuracy, RF_accuracy, AB_accuracy, KN_accuracy],
        'precision': [SVM_precision, DT_precision, RF_precision, AB_precision, KN_precision],
        'recall': [SVM_recall, DT_recall, RF_recall, AB_recall, KN_recall]
        }

index = ['SVM', 'DT', 'RF', 'AB', 'KN']
